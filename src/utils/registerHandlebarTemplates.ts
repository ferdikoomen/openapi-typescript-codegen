...
import partialParametersTypes from '../templates/partials/parametersTypes.hbs';
...
export function registerHandlebarTemplates(root: { httpClient: HttpClient; useOptions: boolean; useUnionTypes: boolean }): Templates {
    ...
    Handlebars.registerPartial('parametersTypes', Handlebars.template(partialParametersTypes));
